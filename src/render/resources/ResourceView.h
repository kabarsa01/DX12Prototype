...
public:
	...
	static ResourceView CreateUAVBuffer(ID3D12Resource* inResource, DescriptorBlock& inBlock, uint16_t inIndex);
	static ResourceView CreateUAVTexture2D(ID3D12Resource* inResource, DescriptorBlock& inBlock, uint16_t inIndex);
