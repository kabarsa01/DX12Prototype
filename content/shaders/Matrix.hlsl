...
float3x3 inverse(float3x3 m)
{
    ...
    adj[0][0] = det2x2(m[1][1], m[1][2], m[2][1], m[2][2]);
    adj[0][1] = -det2x2(m[0][1], m[0][2], m[2][1], m[2][2]);
    adj[0][2] = det2x2(m[0][1], m[0][2], m[1][1], m[1][2]);

    adj[1][0] = -det2x2(m[1][0], m[1][2], m[2][0], m[2][2]);
    adj[1][1] = det2x2(m[0][0], m[0][2], m[2][0], m[2][2]);
    adj[1][2] = -det2x2(m[0][0], m[0][2], m[1][0], m[1][2]);

    adj[2][0] = det2x2(m[1][0], m[1][1], m[2][0], m[2][1]);
    adj[2][1] = -det2x2(m[0][0], m[0][1], m[2][0], m[2][1]);
    adj[2][2] = det2x2(m[0][0], m[0][1], m[1][0], m[1][1]);
